...
public class App 
{
    ...
    public static void main( String[] args )
    {
		...
		LOGGER.info(String.format("Cityname ; %s, trying to load locations from API...", 
				cityName));
		...
		LOGGER.info(String.format("Parsed %d locations... Trying to write to file...", 
				locations.size()));
		...
		LOGGER.info(String.format("Locations were written to file: %s%s. DONE!", 
				cityName, CSV_FILE_EXT));
    }
}
